...
static qboolean NPC_CheckPlayerDistance( void )
{
	...
	ClosestDistance = DistanceSquared( NPCS.NPC->r.currentOrigin, NPCS.NPC->enemy->r.currentOrigin );
	...
	*/
	...
	for( i = 0; i < MAX_CLIENTS; i++ )
	{
		...
		distance = DistanceSquared( NPCS.NPC->r.currentOrigin, player->r.currentOrigin );
