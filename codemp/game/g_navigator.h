...
#include "map_vs.h"
#include "pool_vs.h"
//#include "hfile.h" //not needed since save/loading nav data is disabled by default in the SP code.
#include "bits_vs.h"

//Used to toggle/determine which way we're trying to scan/move around obstructions
//--------------------------------------------------------------------------------
typedef enum
{
	Side_None,
...
namespace NAV
{
	...
	bool			TestEdge( TNodeHandle NodeA, TNodeHandle NodeB, bool IsDebugEdge );
