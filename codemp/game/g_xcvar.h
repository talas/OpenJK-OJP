...
XCVAR_DEF( bot_cpu_usage,			"0",			NULL,				CVAR_NONE,					qtrue )
...
XCVAR_DEF( d_saberBodyCheck,			"1",		NULL,				CVAR_NONE,							qtrue )
...
XCVAR_DEF( g_allowBotLimit,				"0",			NULL,				CVAR_SERVERINFO|CVAR_ARCHIVE,			qtrue )
...
XCVAR_DEF( g_corpseRemovalTime,			"30",			NULL,				CVAR_NONE,						qtrue )
...
XCVAR_DEF( g_debugsabercombat,			"0",			NULL,				CVAR_CHEAT,						qtrue )
...
XCVAR_DEF( g_duelStats,					"0",			NULL,				CVAR_ARCHIVE,					qtrue )
XCVAR_DEF( g_duelTimer,					"10",			NULL,				CVAR_ARCHIVE,					qtrue )
...
XCVAR_DEF( g_forceRegenTime,			"50",			NULL,				CVAR_SERVERINFO|CVAR_ARCHIVE,									qtrue )
...
XCVAR_DEF( g_knockback,					"175",			NULL,				CVAR_NONE,										qtrue )
...
XCVAR_DEF( g_logDuelStats,				"0",			NULL,				CVAR_ARCHIVE,						qtrue )
XCVAR_DEF( g_logSync,					"0",			NULL,				CVAR_ARCHIVE,									qfalse )
XCVAR_DEF( g_maxBots,					"1",			NULL,				CVAR_SERVERINFO|CVAR_ARCHIVE,				qfalse )
XCVAR_DEF( g_maxConnPerIP,				"3",			NULL,				CVAR_ARCHIVE,									qfalse )
XCVAR_DEF( g_maxForceRank,				"250",			NULL,				CVAR_SERVERINFO|CVAR_ARCHIVE|CVAR_LATCH,		qfalse )
...
XCVAR_DEF( g_minForceRank,				"15",			NULL,				CVAR_SERVERINFO|CVAR_ARCHIVE|CVAR_LATCH,		qfalse )
XCVAR_DEF( g_minHumans,				"2",			NULL,				CVAR_SERVERINFO|CVAR_ARCHIVE,					qfalse )
...
XCVAR_DEF( g_playerDuelShield,				"50",			NULL,				CVAR_ARCHIVE,						qfalse )
...
XCVAR_DEF( g_saberanimspeed,			"1",			NULL,				CVAR_SERVERINFO|CVAR_ARCHIVE|CVAR_SYSTEMINFO,			qtrue )
...
XCVAR_DEF( g_speed,						"210",			NULL,				CVAR_NONE,										qtrue )
...
XCVAR_DEF( ojp_dodgemulti,				"10.0",			NULL,				CVAR_LATCH,						qfalse )
XCVAR_DEF( ojp_ffaRespawnTimer,				"1",			NULL,				CVAR_ARCHIVE,						qtrue )
XCVAR_DEF( ojp_lastmanstanding,				"0",			NULL,				CVAR_LATCH,						qfalse )
XCVAR_DEF( ojp_liveExp,					"5",			NULL,				CVAR_LATCH,						qfalse )
XCVAR_DEF( ojp_lmslives,				"1",			NULL,				CVAR_LATCH,						qfalse )
XCVAR_DEF( ojp_modelscaleEnabled,			"1",			NULL,				CVAR_ARCHIVE,						qtrue )
XCVAR_DEF( ojp_MOTD,					"This server is running OpenJK-OJP.  Your game WILL CRASH without it. You can get it from jkhub.org",	NULL,	CVAR_ARCHIVE,	qfalse )
XCVAR_DEF( ojp_skipcutscenes,				"0",			NULL,				CVAR_SERVERINFO|CVAR_ARCHIVE,				qtrue )
XCVAR_DEF( ojp_spmodel,					"jan",			NULL,				CVAR_ARCHIVE,						qtrue )
XCVAR_DEF( ojp_spmodelrgb,				"255 255 255",		NULL,				CVAR_ARCHIVE,						qtrue )
