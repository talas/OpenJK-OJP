...
// 74145 FIXME: rank is skillPoints. which can be several digits now..
#define DEFAULT_FORCEPOWERS_LEN (50) // numPowers + +numSkills + rank + side + separators
...
//DP cost of breaking a saber lock.
#define DODGE_SABERLOCK_BREAK 10
//[/DodgeDefines]
//[/DodgeSys]
...
//FP cost of breaking out of a saber lock
#define FATIGUE_SABERLOCK_BREAK	50

#define FATIGUE_REGEN_DEBOUNCE	g_forceRegenTime.integer	//delay to fatigue regen after doing something you can't regen FP during.
...
//[NPCSandCreature]
extern void BG_AttachToSandCreature( void *ghoul2, float rancYaw, vec3_t rancOrigin, int time, qhandle_t *modelList, vec3_t modelScale, vec3_t out_origin, vec3_t out_angles, matrix3_t out_axis );
//[/NPCSandCreature]
