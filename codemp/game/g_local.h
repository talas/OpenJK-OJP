...
//Health and damage fields
	...
	qboolean	takedamage;
	material_t	material;
	int			damageDecreaseTime; //[Bowcaster]
...
//[DodgeSys]
#define DISRUPTOR_MAX_CHARGE (level.gametype == GT_SIEGE ? 200 : 60) //max charge on disruptor's alt fire.
