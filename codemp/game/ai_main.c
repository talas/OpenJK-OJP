...
*/
//[AotCAI]
extern void FastBotAI(bot_state_t *bs, float thinktime);
extern void AOTC_StandardBotAI(bot_state_t *bs, float thinktime);
extern void HYBRID_StandardBotAI(bot_state_t *bs, float thinktime);
//[/AotCAI]
...
int BotAISetup( int restart ) {
	...
	trap->Cvar_Register(&bot_wp_distconnect, "bot_wp_distconnect", "0", 0);
	trap->Cvar_Register(&bot_wp_visconnect, "bot_wp_visconnect", "0", 0);
	...
	trap->Cvar_Register(&bot_wp_editornumber, "bot_wp_editornumber", "0", 0);
	//[/BotTweaks]
